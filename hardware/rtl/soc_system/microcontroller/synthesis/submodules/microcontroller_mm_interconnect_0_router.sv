...
module microcontroller_mm_interconnect_0_router
(
    // -------------------
    // Clock & Reset
    // -------------------
    ...
    localparam PAD4 = log2ceil(64'h22800 - 64'h22000); 
    // -------------------------------------------------------
    // Work out which address bits are significant based on the
    // address range of the slaves. If the required width is too
    // large or too small, we use the address field width instead.
    // -------------------------------------------------------
    localparam ADDR_RANGE = 64'h22800;
    ...
    microcontroller_mm_interconnect_0_router_default_decode the_default_decode(
    ...
    // ( 0x22000 .. 0x22800 )
    if ( {address[RG:PAD4],{PAD4{1'b0}}} == 18'h22000   ) begin
