...
# ---- NiosV on-demand SDRAM framebuffer access (Avalon-MM <-> AV_* bridge) ----
add_fileset_file Avalon_Sdram_Port.v   VERILOG PATH Sdram_Control_4Port/Avalon_Sdram_Port.v
...
#
# connection point avs2_clk (independent clock for the NiosV SDRAM bridge -
# does NOT need to match `clk` above; the bridge has its own CDC synchronizers)
#
add_interface avs2_clk clock end
set_interface_property avs2_clk clockRate 0
set_interface_property avs2_clk ENABLED true
add_interface_port avs2_clk avs2_clk clk Input 1

#
# connection point avs2_reset (active-low, synchronous to avs2_clk)
#
add_interface avs2_reset reset end
set_interface_property avs2_reset associatedClock avs2_clk
set_interface_property avs2_reset synchronousEdges DEASSERT
set_interface_property avs2_reset ENABLED true
add_interface_port avs2_reset avs2_reset_n reset_n Input 1

#
# connection point avs2 - Avalon-MM slave (NiosV direct SDRAM framebuffer access)
#
add_interface avs2 avalon end
set_interface_property avs2 addressUnits WORDS
set_interface_property avs2 associatedClock avs2_clk
set_interface_property avs2 associatedReset avs2_reset
set_interface_property avs2 bitsPerSymbol 8
set_interface_property avs2 burstOnBurstBoundariesOnly false
set_interface_property avs2 burstcountUnits WORDS
set_interface_property avs2 explicitAddressSpan 0
set_interface_property avs2 holdTime 0
set_interface_property avs2 linewrapBursts false
set_interface_property avs2 maximumPendingReadTransactions 0
set_interface_property avs2 maximumPendingWriteTransactions 0
set_interface_property avs2 readLatency 0
set_interface_property avs2 readWaitTime 1
set_interface_property avs2 setupTime 0
set_interface_property avs2 timingUnits Cycles
set_interface_property avs2 writeWaitTime 0
set_interface_property avs2 ENABLED true

add_interface_port avs2 avs2_address     address      Input  22
add_interface_port avs2 avs2_read        read         Input  1
add_interface_port avs2 avs2_readdata    readdata     Output 32
add_interface_port avs2 avs2_write       write        Input  1
add_interface_port avs2 avs2_writedata   writedata    Input  32
add_interface_port avs2 avs2_waitrequest waitrequest  Output 1
