...
def benchmark_yoloe_video_intel(video_path, prompt_classes, model_weights="yoloe-26n-seg.pt"):
    ...
    print("Starting video inference benchmark on Intel GPU... (Press 'q' to stop)")
    ...
    while True:
        ...
        # Run prediction routing to the Intel Graphic Card using device="intel:gpu"
        ...
        cv2.imshow("YOLOE OpenVINO Intel GPU Benchmark", annotated_frame)
