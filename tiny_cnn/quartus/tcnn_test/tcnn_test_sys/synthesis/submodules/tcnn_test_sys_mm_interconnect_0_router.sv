...
module tcnn_test_sys_mm_interconnect_0_router_default_decode
  #(
...
module tcnn_test_sys_mm_interconnect_0_router
(
    // -------------------
    // Clock & Reset
    // -------------------
    ...
    localparam PAD4 = log2ceil(64'h31008 - 64'h31000); 
    ...
    // -------------------------------------------------------
    localparam ADDR_RANGE = 64'h32080;
    ...
    tcnn_test_sys_mm_interconnect_0_router_default_decode the_default_decode(
