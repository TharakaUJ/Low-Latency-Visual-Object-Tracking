// tcnn_test_sys_intel_niosv_m_0.v
...
`timescale 1 ps / 1 ps
module tcnn_test_sys_intel_niosv_m_0 (
	...
	tcnn_test_sys_intel_niosv_m_0_hart #(
	...
	tcnn_test_sys_intel_niosv_m_0_irq_mapper irq_mapper (
		.clk           (clk),                      //       clk.clk
	...
	tcnn_test_sys_intel_niosv_m_0_irq_mapper irq_mapper_001 (
		.clk           (clk),                          //       clk.clk
		.reset         (reset_reset),                  // clk_reset.reset
	...
	tcnn_test_sys_intel_niosv_m_0_irq_mapper irq_mapper_002 (
		.clk           (clk),                          //       clk.clk
		.reset         (reset_reset),                  // clk_reset.reset
